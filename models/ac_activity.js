...
// Ideally there should be a modular interface for the model layer.
...
const setupDefaultAssociations = function (activity, user, domain, community, group, done) {
  async.parallel([
    function(callback) {
...
module.exports = function(sequelize, DataTypes) {
  ...
  AcActivity.associate = function(models) {
  ...
  AcActivity.createActivity = function(options, callback) {
  ...
  AcActivity.createPasswordRecovery = function(user, domain, community, token, done) {
    sequelize.models.AcActivity.build({
  ...
  AcActivity.inviteCreated = function(options, done) {
    sequelize.models.AcActivity.build({
