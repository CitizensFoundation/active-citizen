...
export class CreateIdeasProcessor extends BaseProcessor {
  async renderRefinePrompt(
    ...
    const messages = [
      new SystemChatMessage(
        `
        You are an expert trained to analyse complex problem statements and sub-problems to refine innovative ideas for solutions to those problems.

        Adhere to the following guidelines:
        1. Review all the ideas previously generated by you and others.
      ...
      new HumanChatMessage(
        ...
        Previous Ideas JSON Output To Review and Refine:
        ${JSON.stringify(results, null, 2)}

        New Refined Ideas JSON Output:
       `
      ),
    ];
  ...
  async createIdeas(
    ...
    if (IEngineConstants.enable.refine.createIdeas) {
