...
export class CreateSolutionsProcessor extends BaseProcessor {
  ...
  async renderRefinePrompt(
    ...
    const messages = [
      new SystemChatMessage(
        `
        You are an expert trained to refine innovative solutions to complex problem statements and sub-problems.
        ...
        6 Use context given to inform and inspire your solutions.
        ...
        9. For the main problem and all sub-problems, generate the search queries, provide an output in the following JSON format:
          [ { title, description, howCanSolutionHelp, mainObstacleToSolutionAdoption } ].
  ...
  renderCreateSystemMessage() {
    return new SystemChatMessage(
      `
      You are an expert trained to create new innovative solutions for complex problem statements and sub-problem with their affected entities.
      ...
      4. Solution descriptions should be at most six sentences long.
      ...
      7. Use the four different contexts given to inform and inspire your solutions.
