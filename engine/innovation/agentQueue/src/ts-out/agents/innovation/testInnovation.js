...
await myQueue.add("agent-innovation", {
    ...
    communityId: 1,
    domainId: 1,
    initialProblemStatement: "Climate change, an escalating global crisis, is manifesting through an extensive range of effects that are severely impacting our planet's ecosystems, biodiversity, and human societies. These impacts necessitate immediate and substantial mitigation measures.",
});
