...
@customElement('cps-view-memory')
export class CpsViewMemory extends YpBaseElement {
  ...
  async connectedCallback() {
    ...
    window.appGlobals.activity(`View Memory - open`);
  }
      ...
      ? html`
          <div class="topContainer layout vertical wrap center-center">
            ...
            <div class="layout horizontal">
              ...
              ></md-checkbox>
              <div class="checkboxText">${this.t('Show elo ratings')}</div>
            </div>
